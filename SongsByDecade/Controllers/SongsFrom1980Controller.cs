...
{
    public class SongsFrom1980Controller : Controller
    {
        private readonly ISongRepository _repo;

        public SongsFrom1980Controller(ISongRepository repo)
        {
            _repo = repo;
        }
        ...
        {
            var songs = _repo.GetAllSongsFrom1980();
            return View(songs);
        }

        public IActionResult ViewSong(int id)
        {
            var song = _repo.GetSongFrom1980(id);
            return View(song);
        }
        ...
        public IActionResult UpdateSongToDatabase(SongsFrom1980 song)
        {
            if (ModelState.IsValid)
            {
                _repo.UpdateSongFrom1980(song);
        ...
        public IActionResult AddSongToDatabase(SongsFrom1980 song)
        {
            if (ModelState.IsValid)
            {
                _repo.AddSongFrom1980(song);
